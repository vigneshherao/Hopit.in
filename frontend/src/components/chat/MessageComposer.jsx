...
export function MessageComposer({ conversationId }) {
  ...
  async function submit() {
    ...
    await sendMessage.mutateAsync({ conversationId, payload: { type: 'text', text, clientMessageId } });
    setText('');
  ...
  return (
    <div className="sticky bottom-0 border-t border-emerald-100 bg-white/90 p-3 backdrop-blur-xl">
      <div className="flex items-end gap-2 rounded-3xl border border-emerald-100 bg-white p-2 shadow-xl shadow-emerald-900/5">
