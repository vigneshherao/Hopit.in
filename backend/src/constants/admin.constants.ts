...
export const ADMIN_ROLE_DEFAULT_PERMISSIONS: Record<(typeof ADMIN_ROLE_SLUGS)[number], readonly string[]> = {
  ...
  'verification-admin': [ADMIN_PERMISSIONS.DASHBOARD_VIEW, ADMIN_PERMISSIONS.USERS_VIEW, ADMIN_PERMISSIONS.USERS_VERIFY],
  'marketplace-admin': [ADMIN_PERMISSIONS.DASHBOARD_VIEW, ADMIN_PERMISSIONS.USERS_VIEW],
  ...
  'moderation-admin': [ADMIN_PERMISSIONS.DASHBOARD_VIEW, ADMIN_PERMISSIONS.USERS_VIEW, ADMIN_PERMISSIONS.USERS_SUSPEND, ADMIN_PERMISSIONS.USERS_RESTORE],
